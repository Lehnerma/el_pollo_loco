const level1 = new Level(
  ...
  [new Cloud("assets/img/5_background/layers/4_clouds/1.png"), new Cloud("assets/img/5_background/layers/4_clouds/2.png")],
  [
    ...
    new BackgroundObject("assets/img/5_background/layers/air.png", 1440 + 720),
    new BackgroundObject("assets/img/5_background/layers/3_third_layer/2.png", 1440 + 720),
    new BackgroundObject("assets/img/5_background/layers/3_third_layer/2.png", 1440 + 720),
    new BackgroundObject("assets/img/5_background/layers/2_second_layer/2.png", 1440 + 720),
    new BackgroundObject("assets/img/5_background/layers/1_first_layer/2.png", 1440 + 720),
  ]
);
